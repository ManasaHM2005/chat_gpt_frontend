                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-3">
                            <button onClick={() => navigate('/chat')} className="w-full flex items-center space-x-3 px-4 py-3 bg-indigo-50 hover:bg-indigo-100 rounded-xl transition text-left">
                            ...
                            <button onClick={() => navigate('/chat')} className="w-full flex items-center space-x-3 px-4 py-3 bg-purple-50 hover:bg-purple-100 rounded-xl transition text-left">
                            ...
                            <button onClick={() => navigate('/settings')} className="w-full flex items-center space-x-3 px-4 py-3 bg-amber-50 hover:bg-amber-100 rounded-xl transition text-left">
